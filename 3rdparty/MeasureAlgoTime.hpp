...
namespace Tools {
    ...
    namespace Time {
        ...
        public:
            ...
            static void Start() {
                s_start_ = std::chrono::steady_clock::now();
            }

            static typename DurationType::rep Elapsed() {
                auto elapsed = std::chrono::duration_cast<DurationType>(
                        std::chrono::steady_clock::now() - s_start_);
        ...
        private:
            ...
            static std::chrono::steady_clock::time_point s_start_;
        };

        template <typename DurationType>
        std::chrono::steady_clock::time_point AlgoTime<DurationType>::s_start_;
